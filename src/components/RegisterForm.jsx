                    ...
                    <div className="w-full flex flex-col items-center justify-center gap-4 md:flex-row">
                        <div className="w-full">
                            <div className="w-full mb-3">
                                <label className="font-roboto text-base text-head-charleston-green font-bold leading-snug dark:text-white">Name</label>
                            </div>
                            <div className="w-full">
                        ...
                        <div className="w-full">
                            <div className="w-full mb-3">
                                <label className="font-roboto text-base text-head-charleston-green font-bold leading-snug dark:text-white">Photo Url</label>
                            </div>
                            <div className="w-full">
                    ...
                    <div className="w-full">
                        <div className="w-full py-2 mb-3">
                            <div className="w-auto flex items-center gap-2">
                                ...
                                <p className="font-roboto text-head-charleston-green text-base font-medium dark:text-white">Accept Term & Condition</p>
                            </div>
                        </div>
                        <div className="w-full">
                            <button className="w-full p-4 border border-head-charleston-green bg-head-charleston-green flex items-center justify-center gap-3 transition ease-linear duration-200 group hover:bg-white dark:bg-primary-yellow dark:hover:bg-dark-black dark:border-dark-black">
                                <span className="font-roboto text-base text-primary-yellow font-bold uppercase group-hover:text-black dark:text-black">Register</span>
                            </button>
                        </div>
                        <div className="w-full text-center mt-7">
                            <p className="font-roboto text-base text-head-charleston-green uppercase font-medium dark:text-dark-gray">Already Have An Account? <Link to='/auth/login' className="underline dark:text-primary-yellow">Login</Link></p>
                        </div>
                    </div>
                </div>
            </form>
